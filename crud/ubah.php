...
$kulinerr = query("SELECT * FROM kuliner WHERE id = $id")[0];
    ...
    <div class="jumbotron" style="height: 600px;">
        ...
        <div style="width: 600px; margin: auto;">
            <form action="" method="post" enctype="multipart/form-data">
                <ul type="none">
                    <input type="hidden" name="id" value="<?= $kulinerr["id"]; ?>">
                    <input type="hidden" name="gambarLama" value="<?= $kulinerr["gambar"]; ?>">
                    <li>
                        <label for="gambar">Masukkan Gambar</label>
                        <img src="../gambar-culinary/<?= $kulinerr['gambar']; ?>" width="200">
                        <input type="file" name="gambar" required>
                    </li>
                    <li>
                        <button type="submit" name="submit" style="margin-top: 20px;">Ubah Data!</button>
                    </li>
                </ul>
            </form>
        </div>
