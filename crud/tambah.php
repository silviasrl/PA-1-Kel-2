        ...
        <div class="row">
            <div class="col-sm-5">
                <form action="" method="post" enctype="multipart/form-data">
                    <ul type="none">
                        <li>
                            <label for="gambar" style="margin-left: 200px;">Masukkan Gambar</label>
                            <input type="file" class="form-control" placeholder="Text input" style="margin-left: 200px;" name="gambar" required>
                        </li>
                        <li>
                            <button type="submit" name="submit" style="margin: 20px 0 0 200px;">Tambah Data!</button>
                        </li>
                    </ul>
                </form>
            </div>
